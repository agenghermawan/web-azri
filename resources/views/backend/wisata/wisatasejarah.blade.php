                                ...
                                @forelse ($data as $item )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary fas fa-eye text-white" href="{{ route('wisata.show',$item->id) }}"></a>

                                            <form action="{{ route('wisata.destroy',$item ->id) }}" method="POST" enctype="multipart/form-data" class="d-inline" >
                                                @csrf
                                                @method('DELETE')
