...
class GalleryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request -> kategori_id == 1 ) {
            return redirect()->route(('list-gallery-sejarah'));
            }
            if ($request -> kategori_id == 2 ) {
                return redirect()->route(('list-gallery-kuliner'));
            }
            if ($request -> kategori_id == 3 ) {
                return redirect()->route(('list-gallery-keluarga'));
            }
            if ($request -> kategori_id == 4 ) {
                return redirect()->route(('list-gallery-alam'));
            }
